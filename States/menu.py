...
class Menu(template.State):
    ...
    def __init__(self, screen):
        ...
        self.titleText = self.titleFone.render("First Person Game", True, (0, 75, 0))
        ...
        self.buttonList = (button.Button(self.screen, "gameplay", [1], "Quick Play", 40,
                           ...
                           button.Button(self.screen, "level_select", None, "Level Select", 40,
                                         buttonTextColour, buttonColour, (0,-50)))
